/**
 * PathwayComparisonChart.js
 *
 * Horizontal bar chart component for comparing multiple decarbonization pathways
 * based on different metrics like cost, emissions, water usage, etc.
 */
import React from 'react';
import PropTypes from 'prop-types';
import './styles/PathwayComparisonChart.css';
 ...
 */
export const PathwayComparisonChart = ({
  pathways = [],
  dataKey,
  format = (value) => value,
  ascending = true,
...
PathwayComparisonChart.propTypes = {
