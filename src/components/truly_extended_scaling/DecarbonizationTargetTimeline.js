/**
 * DecarbonizationTargetTimeline.js
 *
 * Component for visualizing the readiness timeline for a decarbonization pathway,
 * showing its maturity level and readiness year.
 */
import React from 'react';
import PropTypes from 'prop-types';
import './styles/DecarbonizationTargetTimeline.css';
 ...
 */
export const DecarbonizationTargetTimeline = ({
  maturityLevel,
  readinessYear
}) => {
...
DecarbonizationTargetTimeline.propTypes = {
