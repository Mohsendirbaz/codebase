/**
 * DecarbonizationPathwayPanel.js
 *
 * Main component for displaying and comparing decarbonization pathways.
 * Integrates DecarbonizationPathwayCard, PathwayComparisonChart, and DecarbonizationTargetTimeline.
 */
...
import './styles/DecarbonizationPathwayPanel.css';
...
DecarbonizationPathwayPanel.propTypes = {
  pathways: PropTypes.object,
  activePathwayId: PropTypes.string,
  comparisonPathwayIds: PropTypes.array,
  metrics: PropTypes.object,
  onSelectPathway: PropTypes.func,
  onAddToComparison: PropTypes.func,
  onRemoveFromComparison: PropTypes.func,
  onCategoryChange: PropTypes.func,
  filterHardToDecarbonize: PropTypes.bool,
  onToggleHardToDecarbonizeFilter: PropTypes.func
};
