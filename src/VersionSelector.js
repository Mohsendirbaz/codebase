              ...
              >
                ...
                <div className={`version-checkbox ${selectedVersions.includes(version) ? 'checked' : ''}`}>
                  <input
                    ...
                    onChange={() => {
                      // The onChange handler will be called when the checkbox is clicked
                      // We don't need to call handleVersionToggle here because the parent div's
                      // click handler will be called due to event bubbling
                    }}
                    onClick={e => {
                      // Don't stop propagation, let the click event bubble up to the parent div
                      // This ensures the parent div's click handler is called
                      // which will toggle the version selection
                    }}
                    style={{
                      appearance: 'none',
