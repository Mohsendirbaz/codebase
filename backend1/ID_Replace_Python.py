...
TARGET_PHRASES = ["KeyAmount1","KeyAmount2","NewNewNewKeyAmount3"]  # List of phrases to search for
REPLACEMENT_PHRASES = ["NewKeyAmount1","NewKeyAmount2","NewNewNewNewKeyAmount3"]  # Replacement phrases
